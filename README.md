...
Vulnerability scanning for Go projects using `govulncheck`, as described [here](https://pkg.go.dev/golang.org/x/vuln/cmd/govulncheck).
If the scan fails, the action will send an email using AWS SES.
